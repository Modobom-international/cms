...
class LogBehaviorController extends Controller
{
    ...
    public function __construct(LogBehaviorRepository $logBehaviorRepository, Utility $utility)
    {
    ...
    public function logBehavior(Request $request)
    {
        try {
            ...
            $info = [
                ...
                'date' => $this->utility->covertDateTimeToMongoBSONDateGMT7($this->utility->getCurrentVNTime())
            ];
            ...
            $data['date'] = $this->utility->covertDateTimeToMongoBSONDateGMT7($this->utility->getCurrentVNTime());
    ...
    public function viewLogBehavior(Request $request)
    {
        try {
            ...
            return response()->json([
                'success' => true,
                'data' => $response,
                'message' => 'Lấy danh sách log behavior thành công',
                'type' => 'list_log_behavior_success',
            ], 200);
        } catch (Exception $e) {
            return response()->json([
                'success' => false,
                'message' => 'Lấy danh sách log behavior không thành công',
                'type' => 'list_log_behavior_fail',
                'error' => $e->getMessage()
            ], 500);
        }
    }
    ...
    public function getDataChartLogBehavior(Request $request)
    {
        try {
            ...
            return response()->json([
                'success' => true,
                'data' => $data,
                'message' => 'Lấy thông tin chart log behavior thành công',
                'type' => 'chart_log_behavior_success',
            ], 200);
        } catch (Exception $e) {
            return response()->json([
                'success' => false,
                'message' => 'Lấy danh sách log behavior không thành công',
                'type' => 'chart_log_behavior_fail',
                'error' => $e->getMessage()
            ], 500);
        }
    }
    ...
    public function compareDate(Request $request)
    {
        try {
            ...
            return response()->json([
                'success' => true,
                'data' => $response,
                'message' => 'Lấy thông tin compare date thành công',
                'type' => 'compare_date_log_behavior_success',
            ], 200);
        } catch (Exception $e) {
            return response()->json([
                'success' => false,
                'message' => 'Lấy danh sách log behavior không thành công',
                'type' => 'compare_date_log_behavior_fail',
                'error' => $e->getMessage()
            ], 500);
        }
    }
    ...
    public function getActivityUid(Request $request)
    {
        try {
            ...
            return response()->json([
                'success' => true,
                'data' => $getActivity,
                'message' => 'Lấy thông tin activity uid thành công',
                'type' => 'activity_uid_log_behavior_success',
            ], 200);
        } catch (Exception $e) {
            return response()->json([
                'success' => false,
                'message' => 'Lấy thông tin activity uid không thành công',
                'type' => 'activity_uid_behavior_fail',
                'error' => $e->getMessage()
            ], 500);
        }
    }
